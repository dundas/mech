...
export function enhanceError(
  ...
  const enhanced = error as ErrorWithHints;
  enhanced.code = code;
...
export function errorHandler(
  ...
  logger.error(`Error ${code} in ${req.method} ${req.path}:`, {
    error: err.message,
    stack: err.stack,
    body: req.body,
    params: req.params,
...
function getDefaultHints(code: string): string[] {
...
function getDefaultCauses(code: string): string[] {
...
function getDefaultFixes(code: string): string[] {
